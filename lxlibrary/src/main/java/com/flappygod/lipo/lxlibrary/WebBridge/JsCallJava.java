 ...
 * </p>
 * <p>
 * Package: com.etong.mall.web.bridge
 * </p>
 * <p>
...
public class JsCallJava {
    ...
    public JsCallJava(String injectedName, Class injectedCls, Object callObject) {
        try {
            ...
            StringBuilder sb = new StringBuilder(
                    "javascript:try{(function(b){console.log(\"HostApp initialization begin\");var a={queue:[],callback:function(){var d=Array.prototype.slice.call(arguments,0);var c=d.shift();var e=d.shift();this.queue[c].apply(this,d);if(!e){delete this.queue[c];}}};");
            ...
            sb.append("function(){var f=Array.prototype.slice.call(arguments,0);if(f.length<1){throw\"HostApp call error, message:miss method name\";}var e=[];for(var h=1;h<f.length;h++){var c=f[h];var j=typeof c;e[e.length]=j;if(j==\"function\"){var d=a.queue.length;a.queue[d]=c;f[h]=d;}}var g=JSON.parse(prompt(JSON.stringify({method:f.shift(),types:e,args:f})));if(g.code!=200){throw\"HostApp call error, code:\"+g.code+\", message:\"+g.result;}return g.result;};Object.getOwnPropertyNames(a).forEach(function(d){var c=a[d];if(typeof c===\"function\"&&d!==\"callback\"){a[d]=function(){return c.apply(a,[d].concat(Array.prototype.slice.call(arguments,0)));};}});b."
                    + injectedName
                    + "=a;console.log(\"HostApp initialization end\");})(window);}catch(e){};");

            mPreloadInterfaceJS = sb.toString();
        } catch (Exception e) {
            Log.e(TAG, "init js error:" + e.getMessage(), e);
        }
    }
            ...
            try {
                ...
                for (int k = 0; k < len; k++) {
                    ...
                    if ("string".equals(currType)) {
                        ...
                        sign += "_F";
                        values[k + 1] = new JsCallback(webView, injectedName,
                                argsVals.getInt(k));
                    } else {
                        sign += "_P";
                    }
                ...
                // 方法匹配失败
                if (currMethod == null) {
                    return getReturn(jsonStr, 500, "not found method("
                            + methodName + ") with valid parameters");
                }
                // 数字类型细分匹配
                if (numIndex > 0) {
                ...
                return getReturn(jsonStr, 200,
                        currMethod.invoke(callObject, values));
            } catch (Exception e) {
                // 优先返回详细的错误信息
                if (e.getCause() != null) {
